        ...
        <view class="transfer color-333">
            <view class="item line">
                ...
                <view class="input" style="padding: 0 20px;">
                    <text class="color-theme font-bold">转赠罗特币</text>
            ...
            <view class="tips">
                <text class="color-theme font-bold">您有 {{score}} 个罗特币可以转赠</text>
            </view>
            <view class="item line">
            ...
            <view class="list">
                <view class="item" v-for="item in uList" :key="item.id" @tap="selectItem(item)">
                    ...
                    <view class="info">
                        ...
                        <text class="starfish color-999">罗特币数量：{{item.score}}</text>
                    </view>
